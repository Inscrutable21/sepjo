    ...
    <div className="pt-24 pb-16 bg-neutral-50 dark:bg-gray-900">
      <div className="container mx-auto px-4 md:px-6">
        <header className="mb-12 text-center">
          <h1 className="text-3xl md:text-5xl font-bold tracking-tight mb-4 dark:text-white">Our Story</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
          <div>
            <h2 className="text-2xl md:text-3xl font-bold tracking-tight mb-4 dark:text-white">Our Mission</h2>
          ...
          <div>
            <h2 className="text-2xl md:text-3xl font-bold tracking-tight mb-4 dark:text-white">Our Approach</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
        ...
        <section className="mb-16">
          <h2 className="text-2xl md:text-3xl font-bold tracking-tight text-center mb-10 dark:text-white">Why Choose Our Agency</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm">
              <div className="bg-yellow-100 dark:bg-yellow-400/20 w-12 h-12 rounded-full flex items-center justify-center mb-4 mx-auto">
              ...
              <h3 className="text-xl font-bold text-center mb-2 text-gray-900 dark:text-white">Creative Excellence</h3>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm">
              ...
              <h3 className="text-xl font-bold text-center mb-2 text-gray-900 dark:text-white">Data-Driven Results</h3>
              <p className="text-gray-700 dark:text-gray-300 text-center">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm">
              ...
              <h3 className="text-xl font-bold text-center mb-2 text-gray-900 dark:text-white">Full-Service Solutions</h3>
              <p className="text-gray-700 dark:text-gray-300 text-center">
        ...
        <section className="bg-gray-100 dark:bg-gray-800 rounded-xl p-8 md:p-12 mb-16">
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-bold tracking-tight mb-4 dark:text-white">Our Process</h2>
        ...
        <section className="mb-16">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <div>
              <h2 className="text-2xl md:text-3xl font-bold tracking-tight mb-4 dark:text-white">Our Commitment to Innovation</h2>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
        ...
        <section className="bg-yellow-50 dark:bg-yellow-900/20 rounded-xl p-8 md:p-12 mb-16">
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-bold tracking-tight mb-4 dark:text-white">Meet Our Team</h2>
            <p className="text-gray-700 dark:text-gray-300 max-w-2xl mx-auto">
        ...
        <div className="text-center">
          <h2 className="text-2xl md:text-3xl font-bold tracking-tight mb-6 dark:text-white">Ready to Amplify Your Brand?</h2>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link 
              href="/services" 
              className="px-8 py-3 bg-yellow-500 hover:bg-yellow-600 text-white rounded-full transition-colors font-medium"
            >
              View Our Services
            </Link>
            <Link 
