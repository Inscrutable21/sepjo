...
export default function AdminSidebar({ admin, sidebarOpen, setSidebarOpen, onLogout }) {
        ...
        <div className="flex min-h-0 flex-1 flex-col bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700">
          ...
          <div className="flex flex-shrink-0 border-t border-gray-200 dark:border-gray-700 p-4">
            <div className="flex w-full items-center">
              ...
              <button
                onClick={onLogout}
                className="ml-3 flex-shrink-0 bg-red-600 hover:bg-red-700 text-white p-2 rounded-md transition-colors duration-150"
                title="Logout"
              >
      ...
      <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 transform transition-transform duration-300 ease-in-out lg:hidden ${
        ...
        <div className="flex h-16 items-center justify-between px-4 border-b border-gray-200 dark:border-gray-700">
          ...
          <button
            ...
            className="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors duration-150"
          >
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 p-4">
          ...
          <button
            onClick={onLogout}
            className="w-full flex items-center justify-center px-4 py-2 bg-red-600 hover:bg-red-700 text-white text-sm font-medium rounded-md transition-colors duration-150"
          >
